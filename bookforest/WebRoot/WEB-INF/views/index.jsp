	...
	<body class="no-trans">
									...
									<div class="container-fluid">
										...
										<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
											<ul class="nav navbar-nav navbar-right">
												<li class="active"><a href="#banner"> <i class="fa fa-home"></i> 主页</a></li>
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 id="about" class="title text-center">关于 <span>书林</span></h1>
						<p class="lead text-center">我们致力于为您提供写作和阅读的一站式服务</p>
						<div class="space"></div>
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<p>
									书林采取日记和博客结合的新模式，为更多的人服务。除了日常记录，书林想让每一位创作者和记录者变得平静、幸福
									、以及更加优秀，结交到性情相近的朋友，甚至让他们的人生从此有着质的飞越。

								</p>
								<p>
									难在『坚持』我们有时候想要对自己的知识进行整理，对自己的日常进行记录，却止步于繁琐的软件，以及较差平台同步性。
									更多是在繁琐的操作中忘却了自己的灵感，记录完后，也少有时间想起，所有我们需要更简单的写作方式，并且通过写作给我们
									带来成就感。
								</p>
								<ul class="list-unstyled">
									<li><i class="fa fa-caret-right pr-10 text-colored"></i>更加快捷的写作的方式</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i>极简的写作体验</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i>更加丰富的原创文章社区</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i>有成就感的写作方式</li>
									<li><i class="fa fa-caret-right pr-10 text-colored"></i>从此刻改变！</li>
								</ul>
							</div>
						</div>
						<div class="space"></div>
		...
		<div class="section translucent-bg bg-image-1 blue">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<h1 id="services"  class="text-center title"> 价  格</h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-sm-6">
						<div class="media">
							<div class="media-body text-left">
								...
								<p>文件数300, 月流量100MB，￥30每5年</p>

								<p>	如果你的博客内没有插图，每日的访客也就几十人，这个计划会非常适合你。在未来5年内，都不用担心续费的问题。</p>
							</div>
						...
						<div class="media">
							<div class="media-body text-left">
								...
								<p>文件数500, 月流量2GB， ￥65每年</p>

								<p>在你的博客里，偶尔会在文章中穿插几张照片，亦或经常写文的，每篇文章也有一些访问量。
									这是一片用心经营的天地，作为日常使用，这个计划会非常适合你。
									另外，一年期到之后，如果不续费，账户会降级为Basic，自动再获得5年的Basic延期。</p>
							</div>
							<div class="media-right">
						...
						<div class="media">
							<div class="media-body text-left">
								<h4 class="media-heading">Senior</h4>
								<p>
									文件数3,000, 月流量20GB，￥120每年</p>
								<p>
									除了博客、日记，你还需要将书林作为相册使用，比如说经常按下快门，或者经常旅行。
									也可能你的博客已经有了固定的读者群，偶尔会产出一篇被很多人传播的好文。
									你需要更大的容量与流量，这个计划就会非常适合你。
								</p>
							</div>
							<div class="media-right">
						...
						<div class="media">
							<div class="media-body text-left">
								<h4 class="media-heading">Pro</h4>
								<p>
									文件数30,000（约为150GB照片） 月流量100GB ￥300每年
								</p>
								<p>
									有很多照片，比如经常旅行，经常拍摄美食，或者正在用照片记录小朋友的成长。
									又或许你是一名极有人气的博主。
									你需要一个基本不受限的容量与流量，这个计划就会非常适合你。
								</p>
							</div>
							<div class="media-right">
					...
					<div class="col-sm-6">
						<div class="media">
							...
							<div class="media-body">
								...
								<p>
								<ul class="list-unstyled">
									<li><i></i>1. 文件数是指图片等静态文件的总共累计数量，文章（小于2万字）不计入内;</li>
									<li><i ></i>2. 书林提供7天的退款期（Basic除外），但你需要遵循我们的使用条款。</li>
									<li><i ></i>3. 如果当前月流量超出，结算的时候将通过减少账户有效期（单位为`月`）进行补足。</li>
									<li><i ></i>4. 账户升级的时候，原有的账户（非Basic）会按比例折算进行叠加。</li>
									<li><i ></i>5. 非Basic类型的账户，过期降级时，不需要额外支付费用，Basic会自动延期至之后的5年。</li>
									<li><i ></i>6. 所有的收费仅覆盖书林提供的在线服务。</li>
								</ul>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h1 class="text-center">尽情地    享受写作吧！</h1>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section">
			<div class="container">
				<h1 class="text-center title" id="portfolio">模  板</h1>
				<div class="separator"></div>
				<p class="lead text-center">我们为用户提供丰富多彩的个人主页模板，部分免费使用<br> 当然你可以选择购买后永久使用！</p>
				<br>			
		...
		<div class="section translucent-bg bg-image-2 pb-clear">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<h1 id="clients" class="title text-center">书林  ·  社区</h1>
				<p class="lead text-center">为你提供优质的原创内容</p>
				<div class="space"></div>
				<div class="row">
					<div class="col-md-4">
						<div class="media testimonial">
							...
							<div class="media-body">
								<h3 class="media-heading">阅读  ·  简洁</h3>
								<blockquote>
									<p>在书林社区，每天你都可以阅读到最新的优秀原创文章，根据你的喜好，为你精选文章，为你把握每一分</p>
									<footer>你的时间很宝贵</cite></footer>
								</blockquote>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="media testimonial">
							...
							<div class="media-body">
								<h3 class="media-heading">阅读  ·  丰富</h3>
								<blockquote>
									<p>书林社区设立多样的板块，来自各行各业的人们提笔分享他们的故事和经验，这些原创内容异常宝贵，每一次阅读都是一份收货</p>
									<footer>你的眼界需要开拓</footer>
								</blockquote>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="media testimonial">
							...
							<div class="media-body">
								<h3 class="media-heading">阅读  ·  成就</h3>
								<blockquote>
									<p>书林鼓励每一位用户都可以提笔分享自己的故事，并期待和书林一样，认同你故事的人出现</p>
									<footer>你的文字很动人</footer>
								</blockquote>
							</div>
						</div>
					</div>
		...
		<footer id="footer">
			...
			<!-- <div class="modal fade" id="regist-modal" tabindex="-1" role="dialog" aria-labelledby="regist-modal-label" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
							<h4 class="modal-title" id="regist-modal-label">用户注册</h4>
						</div>
						<div class="modal-body">
			...
			<div class="subfooter">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<p class="text-center">Copyright © 2017 书林  .</p>
						</div>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript" src="js/index/template.js"></script>
